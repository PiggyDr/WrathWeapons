...
public class UnhoolyHammerTimeItem extends PickaxeItem {
	public UnhoolyHammerTimeItem() {
		super(new Tier() {
			public int getUses() {
				return 0;
			}
		...
		}, 1, -2.75f, new Item.Properties().fireResistant());
	}

	@Override
	public boolean hurtEnemy(ItemStack itemstack, LivingEntity entity, LivingEntity sourceentity) {
		boolean retval = super.hurtEnemy(itemstack, entity, sourceentity);
		UnhoolyHammerTimeLivingEntityIsHitWithToolProcedure.execute(sourceentity);
		return retval;
	}
