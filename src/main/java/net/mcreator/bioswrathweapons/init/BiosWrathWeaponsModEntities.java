...
public class BiosWrathWeaponsModEntities {
    ...
    public static final RegistryObject<EntityType<ThrownBallsDelightfulPan>> THROWN_BDPAN = REGISTRY.register("balls_delightful_pan", () -> EntityType.Builder.of(ThrownBallsDelightfulPan::new, MobCategory.MISC)
